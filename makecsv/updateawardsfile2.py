...
with open("data/ml-latest-small/award_id2.csv", "r", encoding="utf-8") as award_file:
    reader = csv.DictReader(award_file)
    for row in reader:
        award_dict[row["award_name"]] = row["awardId"]  # Map award_name to award_id
...
with open(input_file, "r", encoding="utf-8") as infile, open(output_file, "w", encoding="utf-8", newline="") as outfile:
    ...
    fieldnames = ["year_film", "year_ceremony", "ceremony", "award_id", "nominee", "film", "winner"]  # Replace 'category' with 'award_id'
